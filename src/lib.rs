...
#[derive(Debug)]
pub struct YarnHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl YarnHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting YarnHub processing");
    
    let mut processor = YarnHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = YarnHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = YarnHubProcessor::new(false);
